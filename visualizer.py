...
plt.savefig('output-pictures/location_counts.png')
plt.show()
...
plt.ylabel('Number of commuters -->')
plt.xticks(rotation=45)
plt.savefig('output-pictures/mode_counts.png')
plt.show()
...
plt.xticks(rotation=45)
plt.savefig('output-pictures/average_commute_time_byloc.png')
plt.show()
...
plt.ylabel('Average Commute time -->')
plt.xticks(rotation=45)
plt.savefig('output-pictures/average_commute_time_bymot.png')
plt.show()
...
plt.ylabel('Number of Commuters')
plt.xticks(rotation=45)
plt.savefig('output-pictures/mode_usage_by_location.png')
plt.show()
